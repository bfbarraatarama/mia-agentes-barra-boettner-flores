...
La distinción entre estado vigente y memoria acumulada es importante cuando una compactación recibe un summary previo junto con observaciones posteriores. El resumen anterior no se trata como una fuente con la misma autoridad que la evidencia nueva: las observaciones posteriores tienen precedencia. El nuevo compactor debe reconstruir el estado completo, corrigiendo hechos contradichos, reemplazando estrategias invalidadas, dejando de presentar como pendientes los subobjetivos ya completados y evitando conservar como alternativas viables caminos que la evidencia ya descartó. Se mantienen además las instrucciones de no inventar información y de preservar textualmente códigos, claves, combinaciones y mensajes de error relevantes.
