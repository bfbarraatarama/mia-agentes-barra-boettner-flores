...
El costo, sin embargo, crece con fuerza y muchas continuaciones siguen consumiendo acciones en trayectorias improductivas. Adoptamos por ello `multi_attempt_recovery` como referencia para la siguiente intervención, pero no como solución suficiente: el próximo experimento busca mejorar la disciplina de ejecución para reducir repetición y trabajo improductivo antes de alcanzar los límites que disparan estas recuperaciones.
